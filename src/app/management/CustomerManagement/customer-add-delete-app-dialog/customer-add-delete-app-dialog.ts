...
import { AppCustomerDTO, AppListDTO, CustomerAddDeletAppModel, CustomerAppGiaHanModel, CustomerModelDTO } from '../../Model/customer-management.model';
...
@Component({
  selector: 'app-customer-add-delete-app-dialog',
  imports: [CommonModule , FormsModule, ReactiveFormsModule , MatFormFieldModule, TranslateModule,
     MatSelectModule,
     MatInputModule,
    MatOptionModule,
     MatCheckboxModule,
  ...
  templateUrl: './customer-add-delete-app-dialog.html',
  styleUrl: './customer-add-delete-app-dialog.scss',
})
export class CustomerAddDeleteAppDialog {
 item: CustomerAppGiaHanModel = new CustomerAppGiaHanModel();
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CustomerAddDeleteAppDialog>,
