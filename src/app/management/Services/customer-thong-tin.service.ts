...
import { AppCustomerDTO, AppListDTO, CustomerAddDeletAppModel, CustomerAppGiaHanModel, CustomerAppStatusModel, CustomerModel, CustomerResetPasswordModel } from '../Model/customer-management.model';
...
// export interface AppCustomerDTO {
//   AppName: string;
//   AppCode: string;
//   EndDate: string;
//   Status: boolean;
