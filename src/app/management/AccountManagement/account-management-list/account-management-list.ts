...
import { AccountManagementEditDialogComponent } from '../account-management-edit-dialog/account-management-edit-dialog';
import { CommonModule } from '@angular/common';
import { MatTableModule } from '@angular/material/table';
import { AccountManagementStatusDialogComponent } from '../account-management-status-dialog/account-management-status-dialog';
...
@Component({
  ...
  imports: [SharedModule, TranslateModule, PaginatorComponent, MatIconModule, SortIconComponent , CommonModule,ReactiveFormsModule,MatTableModule,MatDialogModule ],
  templateUrl: './account-management-list.html',
})
export class AccountManagementList implements OnInit, OnDestroy  {
  ...
  update(item) {
    ...
    dialogRef.afterClosed().subscribe((res) => {
      if (!res) {
        ...
        this.layoutUtilsService.showActionNotification(saveMessage, messageType, 114000, true, false);
        this.accountManagementService.fetch();
      }
    });
  }
