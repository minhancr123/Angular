import { CustomerAddDeletAppModel, LoModel } from '../Model/customer-management.model';
...
export class CustomerThongTinService {
  ...
  public getLoList() : Observable<ResultModel<LoModel>>{
     const httpHeaders = this.httpUtils.getHTTPHeaders();
      const url = API_PRODUCTS_URL + `/GetLoList`;
